...
OLD_AUDIO_DIR = "D:/near_end_signal/near_end_signal/audio_files"

# File metadata hiện tại (được tạo ra từ bước download trước)
METADATA_FILE = "D:/near_end_signal/near_end_signal/dataset_info.jsonl"

# Nơi lưu dataset mới (Nên tạo folder mới để an toàn)
OUTPUT_DIR = "D:/near_end_signal/near_end_v2"
